import { AppBar, Button, Container, Drawer, IconButton, Modal, Toolbar, Typography } from "@mui/material";
        ...
        <AppBar position='static' sx={{ bgcolor:'secondary.main' }}>
            ...
            <Container disableGutters>
                <Toolbar sx={{ display:{ xs:'flex', md: 'none' } }}>
                    <IconButton onClick={() => {setModalOpen(!ModalOpen)}} size="large">
                        <MenuIcon fontSize="large"/>
                    </IconButton>
                    <Button onClick={chengeHome} sx={{ my:1, mx:'auto' }}>
            ...
            >
                <Stack direction='column' alignContent='center' sx={{ bgcolor:'secondary.main', py:2 }}>
                    {AppBarItemList.map(( AppBarItem ) => {
                        return(
                            <Button key={AppBarItem.text} onClick={AppBarItem.action} sx={{ mb:1 }}>
                                <Typography variant="h6">
                                    {AppBarItem.text}
                                </Typography>
                            </Button>
                    ...
                    <Button onClick={chengeUser}>
                        <AccountCircleIcon fontSize="large" sx={{ color:'primary.main', mr:1 }}/>
                        <Typography variant="h6">
                            ユーザ設定
                        </Typography>
                    </Button>
